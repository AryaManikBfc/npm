...
global.called = false
global.Prefix = ['','!','.','🐦','🐤','🗿']
global.ownerNumber = '6281299609670'
global.botName = 'Ochobot' 
global.owner = ['6281299609670', '6281299609670', '6281299609670', '6281299609670']
global.ownerName = 'XdimsDev'
...
const reply2 = (teks) => {
Manik.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botName}`,"body": `XdimsDev OFFICIAL Goup`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Manik.jpg`),"sourceUrl": "https://chat.whatsapp.com/D8lpCpDxOPk7FeyElmTzgj"}}}, { quoted: m})
}       
const reply1 = (teks) => {
Manik.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botName}`,"body": `Follow Group XdimsDev`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/Manik.jpg`),"sourceUrl": "https://chat.whatsapp.com/D8lpCpDxOPk7FeyElmTzgj"}}}, { quoted: m})
}
...
const buttonsDefault = [
			{ callButton: { displayText: `Call Owner!`, phoneNumber: `+6281299609670` } },
			{ urlButton: { displayText: `Group Owner`, url : `https://chat.whatsapp.com/D8lpCpDxOPk7FeyElmTzgj` } },
...
global.mess = {
success: 'Berhasil.',
admin: 'Lu Itu Bukan Admin Jadi Jangan Nyuruh Begituan Ngntd!!',
botAdmin: 'Jadiin Admin Dulu Dong Hangdeh',
owner: 'Lu Tu Cuma Member Biasa Bukan Owner, Ini Fitur Khusus Archimedev Ganteng!',
...
if (budy.includes('https://chat.whatsapp.com/')) {
               ...
               if (isAdmins) throw reply(`Admin Mah Bebas Bro`)
               if (isManik) throw reply(`Owner Mah Bebas Bro`)
               let sianj = m.sender
	...
	if (db.chats[m.chat].wame) {
        ...
        if (!isBotAdmins) throw reply(`Bot must be admin first`)
        let gclink = (`https://wa.me/`)
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) throw reply(`Eh sorry it didn't happen, because you sent this wa.me link`)
               if (isAdmins) throw reply(`Admin Mah Bebas Bro`)
               if (isManik) throw reply(`Owner Mah Bebas Bro`)
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd) 
                anu = `ㅤㅤㅤㅤㅤ *Ochobot - Md*

_*hai kak ${pushname !== undefined ? pushname : 'Kak'}*_
_*${ucapanWaktu}*_
Jangan lupa makan😾

alert!!
*BOT INI MASIH DALAM TAHAP PENGEMBANGAN JIKA ADA BUG ATAU ERROR HARAP DI MAKLUMI SUPPORT BOT INI DENGAN CARA DONASI*
┌─❏  *« INFO BOT »*
│               
│  Name Bot :Ochobot
│  Name Own : XdimsDev
│  No Own : wa.me/+6281299609670
│  Grup Bot : https://chat.whatsapp.com/D8lpCpDxOPk7FeyElmTzgj
│  Prefix : ( ${prefix} )
...
└─────────────⎘
  ...
  *« GROUP MENU  »*
 𖥂 ${prefix}linkgroup
  𖥂 ${prefix}antilink [enable/disable]
 𖥂 ${prefix}ephemeral [option]
  𖥂 ${prefix}setppgc [image]
 𖥂 ${prefix}setname [text]
  𖥂 ${prefix}setdesc [text]
 𖥂 ${prefix}group [option]
  𖥂 ${prefix}editinfo [option]
 𖥂 ${prefix}add @tag
  𖥂 ${prefix}kick @tag
 𖥂 ${prefix}hidetag [text]
  𖥂 ${prefix}tagall [text]
 𖥂 ${prefix}promote @tag
  𖥂 ${prefix}demote @tag
 𖥂 ${prefix}vote [text]
  𖥂 ${prefix}devote
 𖥂 ${prefix}upvote
 ...
 𖥂 ${prefix}addtugas
  𖥂 ${prefix}resettugas
 𖥂 ${prefix}outputtugas
  𖥂 ${prefix}hapustugas
 𖥂 ${prefix}addjudultugas
  𖥂 ${prefix}tambah
 𖥂 ${prefix}kali
  𖥂 ${prefix}kurang
 𖥂 ${prefix}bagi
 ...
 *«  OWNER MENU  »*    
 𖥂 ${prefix}chat [option]
  𖥂 ${prefix}getcase [name]
 𖥂 ${prefix}join [link]
  𖥂 ${prefix}leave
 𖥂 ${prefix}setbotpp
  𖥂 ${prefix}block @user
 𖥂 ${prefix}unblock @user
  𖥂 ${prefix}bcgroup
 𖥂 ${prefix}bcall
  𖥂 ${prefix}self
 𖥂 ${prefix}public
 ...
 *« MOVIE MENU »*    
 𖥂 ${prefix}drakorongoing
  𖥂 ${prefix}lk21 query
 𖥂 ${prefix}wattpad url_wattpad
  𖥂 ${prefix}wattpadsearch query
 𖥂 ${prefix}cerpen
  𖥂 ${prefix}ceritahoror
 
 *« RANDOM TEXT MENU »*    
 𖥂 ${prefix}quotes
  𖥂 ${prefix}quotesdiLan
 𖥂 ${prefix}quotesanime
  𖥂 ${prefix}quotesimage
 𖥂 ${prefix}faktaunik
  𖥂 ${prefix}katabijak
 𖥂 ${prefix}pantun
  𖥂 ${prefix}bucin
 ...
 *«  WIBU MENU  »*  
 ...
 𖥂 ${prefix}nakanomiku
  𖥂 ${prefix}nakanonino
 𖥂 ${prefix}nakanoitsuki
  𖥂 ${prefix}otakuongoing
 𖥂 ${prefix}nhentai *code*
  𖥂 ${prefix}nekopoi *link*
 𖥂 ${prefix}nekopoisearch
 ...
 𖥂 ${prefix}delttt
  𖥂 ${prefix}tictactoe
 𖥂 ${prefix}family100
  𖥂 ${prefix}tebak [option]
 𖥂 ${prefix}math [mode]
  𖥂 ${prefix}suitpvp [@tag]
 𖥂 ${prefix}casino
  𖥂 ${prefix}delcasino
 𖥂 ${prefix}akinator
  𖥂 ${prefix}cancelakinator
  
 *«  DOWNLOAD MENU  »*
 𖥂 ${prefix}tiktok [url]
  𖥂 ${prefix}tiktokaudio [url]
 𖥂 ${prefix}tiktoknowm [url]     
  𖥂 ${prefix}Group [url]
 𖥂 ${prefix}twitter [url]
  𖥂 ${prefix}twittermp3 [url]
 𖥂 ${prefix}facebook [url]
  𖥂 ${prefix}pinterestdl [url]
 𖥂 ${prefix}ytmp3 [url]
  𖥂 ${prefix}ytmp4 [url]
 𖥂 ${prefix}getmusic [query]
  𖥂 ${prefix}getvideo [query]
 𖥂 ${prefix}umma [url]
  𖥂 ${prefix}joox [query]
 𖥂 ${prefix}soundcloud [url]
  𖥂 ${prefix}ttnowm [url] 
 𖥂 ${prefix}ttaudio [url]     
 ...
 *«  SEARCH MENU  »*
 𖥂 ${prefix}play [query]
  𖥂 ${prefix}yts [query]
 𖥂 ${prefix}google [query]
  𖥂 ${prefix}gimage [query]
 𖥂 ${prefix}pinterest [query]
  𖥂 ${prefix}wallpaper [query]
 𖥂 ${prefix}wikimedia [query]
  𖥂 ${prefix}ytsearch [query]
 𖥂 ${prefix}ringtone [query]
  𖥂 ${prefix}nickff 
 𖥂 ${prefix}nickml
  𖥂 ${prefix}nickpubg
 𖥂 ${prefix}nickdomino
 ...
 *« CEK MENU »*  	
 ...
 𖥂 ${prefix}fakgirlcek
  𖥂 ${prefix}kerencek
 𖥂 ${prefix}wibucek
  𖥂 ${prefix}pasarkascek
 
  *«  STALKING MENU  »*  	
 𖥂 ${prefix}stalkig    _<nama>_
  𖥂 ${prefix}stalkgithub    _<nama>_
 𖥂 ${prefix}stalktwitter    _<nama>_
  𖥂 ${prefix}mlstalk    _<nama>_
 ...
 *«  BOT MENU  »*  	
 𖥂 ${prefix}antilink On/Off
  𖥂 ${prefix}mute On/Off
 𖥂 ${prefix}antiwame On/Off
  𖥂 ${prefix}antiyt On/Off
 𖥂 ${prefix}antitele On/Off
  𖥂 ${prefix}antibitly On/Off
 
  *« Text Pro Me »*  	
 𖥂 ${prefix}blackpink text
  𖥂 ${prefix}neon text
 𖥂 ${prefix}greenneon text
  𖥂 ${prefix}advanceglow text
 𖥂 ${prefix}futureneon text
  𖥂 ${prefix}sandwriting text
 𖥂 ${prefix}sandsummer text
  𖥂 ${prefix}sandengraved text
 𖥂 ${prefix}metaldark text
  𖥂 ${prefix}neonlight text
 𖥂 ${prefix}holographic text
  𖥂 ${prefix}text1917 text
 𖥂 ${prefix}minion text
  𖥂 ${prefix}deluxesilver text
 𖥂 ${prefix}newyearcard text
  𖥂 ${prefix}bloodfrosted text
 𖥂 ${prefix}halloween text
  𖥂 ${prefix}jokerlogo text
 𖥂 ${prefix}fireworksparkle text
  𖥂 ${prefix}natureleaves text
 𖥂 ${prefix}bokeh text
  𖥂 ${prefix}toxic text
 𖥂 ${prefix}strawberry text
  𖥂 ${prefix}box3d text
 𖥂 ${prefix}roadwarning text
  𖥂 ${prefix}breakwall text
 𖥂 ${prefix}icecold text
  𖥂 ${prefix}luxury text
 𖥂 ${prefix}cloud text
  𖥂 ${prefix}summersand text
 𖥂 ${prefix}horrorblood text
  𖥂 ${prefix}thunder text
 𖥂 ${prefix}pornhub text1 text2
  𖥂 ${prefix}glitch text1 text2
 𖥂 ${prefix}avenger text1 text2
  𖥂 ${prefix}space text1 text2
 𖥂 ${prefix}ninjalogo text1 text2
  𖥂 ${prefix}marvelstudio text1 text2
 𖥂 ${prefix}lionlogo text1 text2
  𖥂 ${prefix}wolflogo text1 text2
 𖥂 ${prefix}steel3d text1 text2
  𖥂 ${prefix}wallgravity text1 text2
  ...
  *« Photo Oxy »*  	
 𖥂 ${prefix}shadow text
  𖥂 ${prefix}cup text
 𖥂 ${prefix}cup1 text
  𖥂 ${prefix}romance text
 𖥂 ${prefix}smoke text
  𖥂 ${prefix}burnpaper text
 𖥂 ${prefix}lovemessage text
  𖥂 ${prefix}undergrass text
 𖥂 ${prefix}love text
  𖥂 ${prefix}coffe text
 𖥂 ${prefix}woodheart text
  𖥂 ${prefix}woodenboard text
 𖥂 ${prefix}summer3d text
  𖥂 ${prefix}wolfmetal text
 𖥂 ${prefix}nature3d text
  𖥂 ${prefix}underwater text
 𖥂 ${prefix}goldenrose text
  𖥂 ${prefix}summernature text
 𖥂 ${prefix}letterleaves text
  𖥂 ${prefix}glowingneon text
 𖥂 ${prefix}fallleaves text
  𖥂 ${prefix}flamming text
 𖥂 ${prefix}harrypotter text
  𖥂 ${prefix}carvedwood text
 𖥂 ${prefix}tiktok text1 text2
  𖥂 ${prefix}arcade8bit text1 text2
 𖥂 ${prefix}battlefield4 text1 text2
  𖥂 ${prefix}pubg text1 text2

  *« Ephoto 360 »*  	
 𖥂 ${prefix}wetglass text
  𖥂 ${prefix}multicolor3d text
 𖥂 ${prefix}watercolor text
  𖥂 ${prefix}luxurygold text
 𖥂 ${prefix}galaxywallpaper text
  𖥂 ${prefix}lighttext text
 𖥂 ${prefix}beautifulflower text
  𖥂 ${prefix}puppycute text
 𖥂 ${prefix}royaltext text
  𖥂 ${prefix}heartshaped text
 𖥂 ${prefix}birthdaycake text
  𖥂 ${prefix}galaxystyle text
 𖥂 ${prefix}hologram3d text
  𖥂 ${prefix}greenneon text
 𖥂 ${prefix}glossychrome text
  𖥂 ${prefix}greenbush text
 𖥂 ${prefix}metallogo text
  𖥂 ${prefix}noeltext text
 𖥂 ${prefix}glittergold text
  𖥂 ${prefix}textcake text
 𖥂 ${prefix}starsnight text
  𖥂 ${prefix}wooden3d text
 𖥂 ${prefix}textbyname text
  𖥂 ${prefix}writegalacy text
 𖥂 ${prefix}galaxybat text
  𖥂 ${prefix}snow3d text
 𖥂 ${prefix}birthdayday text
  𖥂 ${prefix}goldplaybutton text
 𖥂 ${prefix}silverplaybutton text
  𖥂 ${prefix}freefire text

  «TQ TO»
  -Archimedev (gua sendiri)
  -Tuhan mksh buat semuanya
  -ayg dah nemenin coding😼
  -emak dah bayarin wifi😅☝️
  
  Dj asede ugh ugh - Viral Tiktok mp3

03:42 ━━━━━━●───── 05:20
⇆ㅤ    ◁ㅤ     ❚❚     ㅤ▷ ㅤ  ㅤ↻﻿`
 Manik.sendMessage(m.chat, { caption: anu, image: { url: "./media/menu.jpg" }, templateButtons: buttonsDefault, footer: 'Ochobot By XdimsDev BOT INI MASIH DALAM TAHAP PENGEMBANGAN JIKA ADA BUG ATAU ERROR HARAP DI MAKLUMI SUPPORT BOT INI DENGAN CARA DONASI wa.me/6281299609670', mentions: [m.sender] })
break 
}
//━━━━━━━━━━━━━━━[ Fitur topup Otomatis server 1 Case Dan Fitur By Manik Only! ]━━━━━━━━━━━━━━━\\
case prefix+'shopeepay':{
if (isGroup) throw reply('Fitur Ini Hanya Bisa Digunakan Di Private Chat!')
let noshp = text
if (isNaN(parseInt(noshp))) throw reply(`${command} 6281299609670`)
const sections = [
    {
...
_For Your Information, Ochobot Hanya Mendukung Deposit Melalui Ovo, Shopeepay, Dana, Qris Saja._
...
_Contoh:_
${prefix}bukti 10000|isi Saldo 6281299609670
...
if (isNaN(parseInt(depo))) throw reply('Deposit Harus Berupa Angka!')
...
let encmedia = await Manik.sendImage(`6281299609670@s.whatsapp.net`, media, `Bukti Dari: ${sender.replace("@s.whatsapp.net", "")}`, m)
let buttons = [
...
Manik.sendButtonText(`6281299609670@s.whatsapp.net`, buttons, `${bukti}`, Manik.user.name, m)
}
break
case prefix+'depoyes':
...
Manik.sendButtonText(`${siapah}`, nbuttons, `Topup Anda Berhasil Di Acc, Silahkan Melakukan TopUp Dengan Mudah Hanya Di Ochobot!`, Manik.user.name, m)
break
case prefix+'depono':
if (!isManik) reply(mess.owner)
...
let idff = text.split("|")[0]
let produkid = text.split("|")[1]
if (isNaN(parseInt(idff))) throw reply('Id Harus Berupa Angka!')
if (isNaN(parseInt(produkid))) throw reply('Jumlah Harus Berupa Angka!')
...
if (isNaN(parseInt(produkid))) throw reply('Jumlah Harus Berupa Angka!')
if (isNaN(parseInt(idml1))) throw reply('Id Harus Berupa Angka!')
if (isNaN(parseInt(idml2))) throw reply('Server Harus Berupa Angka!')
...
axios.get(`https://api.lolhuman.xyz/api/freefire/${idff}?apikey=${lolkey}`)
            .then(({data}) => {
reply('Tunggu Sebentar Kak, Ochobot Akan Cek Id Kakak😊')
            })
            .catch((err) => {
...
break
case 'modesimi':
          if (args.length < 1) throw reply('1/0')
          if (Number(args[1]) === 1) {
          simin.push(from)
...
case prefix+'myotp':
if (isGroup) throw reply(mess.OnlyPM)
...
if (args.length == 1) throw reply('Masukan Otp Nya!')
if (args[1].includes('+')) throw reply(`Jangan menggunakan +`)
if (isNaN(parseInt(args[1]))) throw reply('Otp Harus Berupa Angka!')
...
if (!q.includes("|")) throw reply(`Gunakan dengan cara ${command.slice(1)} *Nama|Email|Password*\n\n_Contoh_\n\n${command.slice(1)} Arya|XdimsDev000@gmail.com|XdimsDev00`)
...
//FITUR WITH TRENDTODAY BY MANIK DENGAN DISTRIBUTOR RAFLI RUSDIANA
		case prefix+'casino':
                 ...
                 if (isGame(sender, isManik, gcount, glimit)) throw reply(`Limit game kamu sudah habis`)
                 if (args.length < 2) throw reply(`Kirim perintah *${command}* @tag nominal`)
                 if (mentionUser.length == 0) throw reply(`Tag Lawan Yang Ingin Diajak Bermain Game`)
                 if (mentionUser.length > 2) throw reply('Hanya bisa dengan 1 orang')
                 if (mentionUser[0] === sender) throw reply(`Sad amat main sama diri sendiri`)
				 if (mentionUser[0] === botNumber) throw reply(`Tidak bisa bermain dengan bot!`)
                 if (fs.existsSync(`./database/${from}.json`)) throw reply(`Sedang Ada Sesi, tidak dapat dijalankan secara bersamaan\nKetik *${prefix}delcasino*, untuk menghapus sesi`)
                 if (args.length == 2) throw reply('Masukan Nominal Nya')
                 if (args[2].includes('-')) throw reply(`Jangan menggunakan -`)
                 if (isNaN(parseInt(args[2]))) throw reply('Nominal Harus Berupa Angka!')
                 var anu = getBalance(sender, balance)
                 var ani = getBalance(mentionUser[0], balance)
                 if (anu < args[2] || anu == 'undefined') throw reply(`Balance Tidak Mencukupi, Kumpulkan Terlebih Dahulu\nKetik ${prefix}balance, untuk mengecek Balance mu!`)
                 if (ani < args[2] || ani == 'undefined') throw reply(`Balance Lawan Tidak Mencukupi Untuk Bermain Denganmu\nKetik ${prefix}balance @tag untuk mengecek Balance lawanmu`)
                 var casinoo = setCasino(`${from}`)
...
//------------------< Premium >-------------------
       case prefix+'premium': 
       addCountCmd(`#${command.slice(1)}`, sender, _cmd) 
              if (!isManik || m.key.fromMe) throw reply(mess.only.owner)
              if (args[1] === 'add') {
       ...
       addCountCmd(`#${command.slice(1)}`, sender, _cmd) 
	    ...
	    case prefix+'family100':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd) 
	if (isGame(sender, isPremium, gcount, glimit)) throw reply(`Limit game kamu sudah habis`)
gameAdd(sender, glimit)
            ...
            case prefix+'buylimit':{
                if (args.length < 2) throw reply(`Kirim perintah *${prefix}buylimit* jumlah limit yang ingin dibeli\n\nHarga 1 limit = $150 balance`)
                if (args[1].includes('-')) throw reply(`Jangan menggunakan -`)
                if (isNaN(args[1])) throw reply(`Harus berupa angka`)
                if (args[1].toLowerCase() === 'infinity') throw reply(`Yahaha saya ndak bisa di tipu`)
                let ane = Number(parseInt(args[1]) * 150)
                if (getMoney(sender, balance) < ane) throw reply(`Balance kamu tidak mencukupi untuk pembelian ini`)
            ...
            case prefix+'tf':{
                 ...
                 if (mentionUser.length == 0) throw reply(`Tag orang yang ingin di transfer balance`)
                 if (!args[2]) throw reply(`Masukkan nominal nya!`)
                 if (isNaN(args[2])) throw reply(`Nominal harus berupa angka!`)
                 if (args[2].toLowerCase() === 'infinity') throw reply(`Yahaha saya ndak bisa di tipu`)
                 if (args[2].includes("-")) throw reply(`Jangan menggunakan -`)
                 var anu = getBalance(sender, balance)
                 if (anu < args[2] || anu == 'undefined') throw reply(`Balance Kamu Tidak Mencukupi Untuk Transfer Sebesar $${args[2]}, Kumpulkan Terlebih Dahulu\nKetik ${prefix}balance, untuk mengecek Balance mu!`)
            ...
            case prefix+'buyglimit':{
                if (args.length < 2) throw reply(`Kirim perintah *${prefix}buyglimit* jumlah game limit yang ingin dibeli\n\nHarga 1 game limit = $150 balance\nPajak $1 / $10`)
                if (args[1].includes('-')) throw reply(`Jangan menggunakan -`)
                if (isNaN(args[1])) throw reply(`Harus berupa angka`)
                if (args[1].toLowerCase() === 'infinity') throw reply(`Yahaha saya ndak bisa di tipu`)
                let ane = Number(parseInt(args[1]) * 150)
                if (getBalance(sender, balance) < ane) throw reply(`Balance kamu tidak mencukupi untuk pembelian ini`)
                ...
                if (isGroup) throw reply(mess.OnlyPM)
                if (akinator.hasOwnProperty(sender.split('@')[0])) throw reply("Selesain yg sebelumnya dulu atuh")
            ...
            case prefix+'cancelakinator':
                if (isGroup) throw reply(mess.OnlyPM)
                if (!akinator.hasOwnProperty(sender.split('@')[0])) throw reply("Anda tidak memiliki akinator sebelumnya")
                delete akinator[sender.split("@")[0]]
                reply(`Sukses`)
                break
            case prefix+'tebak':{
...
gameAdd(sender, glimit)
            ...
            case prefix+'afk':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
            if (!isPremium && global.db.users[m.sender].limit < 1) throw reply(mess.endLimit) // respon ketika limit habis
...
gameAdd(sender, glimit)
	    ...
	    if (m.mentionedJid[0] === m.sender) throw reply(`Can't play with myself !`)
            if (!m.mentionedJid[0]) throw reply(`_Who do you want to challenge?_\nTag the person..\n\nExample : ${prefix}suit @${owner[1]}`, m.chat, { mentions: [owner[1] + '@s.whatsapp.net'] })
...
Ciee Whats Going On💖👀`
	...
	case prefix+'kick':{
		...
		await Manik.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
	}
	break
	case prefix+'add':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
             ...
             videoMsg = (await  Manik.prepareMessageMedia(geayubi, "videoMessage", { thumbnail: geayubi, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await  Manik.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
               Manik.relayWAMessage(prep)
              break
             case 'asupanaura':
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
             const naura = await getBuffer(`https://api-alphabot.herokuapp.com/api/asupan/aura?apikey=${AlphaBot}`)
             buttons = [{buttonId: `${prefix}caca`,buttonText:{displayText: `➡️ NEXT`},type:1}]
             videoMsg = (await  Manik.prepareMessageMedia(naura, "videoMessage", { thumbnail: naura, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await  Manik.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
               Manik.relayWAMessage(prep)
            ...
            const bunga = await getBuffer(`https://api-alphabot.herokuapp.com/api/asupan/bunga?apikey=${AlphaBot}`)
             buttons = [{buttonId: `${prefix}caca`,buttonText:{displayText: `➡️ NEXT`},type:1}]
              videoMsg = (await  Manik.prepareMessageMedia(bunga, "videoMessage", { thumbnail: bunga, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await  Manik.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
               Manik.relayWAMessage(prep)
            ...
            const ayu = await getBuffer(`https://api-alphabot.herokuapp.com/api/asupan/ayu?apikey=${AlphaBot}`)
             buttons = [{buttonId: `${prefix}caca`,buttonText:{displayText: `➡️ NEXT`},type:1}]
             videoMsg = (await  Manik.prepareMessageMedia(ayu, "videoMessage", { thumbnail: ayu, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await  Manik.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
               Manik.relayWAMessage(prep)
             ...
             buttons = [{buttonId: `${prefix}caca`,buttonText:{displayText: `➡️ NEXT`},type:1}]
              videoMsg = (await  Manik.prepareMessageMedia(caca, "videoMessage", { thumbnail: caca, })).videoMessage
              buttonsMessage = {footerText:'KLIK NEXT UNTUK SELANJUTNYA', videoMessage: videoMsg,
              contentText:`DONE`,buttons,headerType:5}
              prep = await  Manik.prepareMessageFromContent(from,{buttonsMessage},{quoted: fhidetag})
               Manik.relayWAMessage(prep)
...
let teks = `══✪〘 *👥 Tag All* 〙✪══
 ...
 ➲ *Message : ${q ? q : 'blank'}*\n\n`
	    ...
	    case prefix+'style': case prefix+'styletext':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
	        if (!isPremium && global.db.users[m.sender].limit < 1) throw reply(mess.endLimit) // response when limit runs out
		            db.users[m.sender].limit -= 1 // -1 limit
...
break
		...
		if (!isPremium && global.db.users[m.sender].limit < 1) throw reply(mess.endLimit) // respon ketika limit habis
            ...
            break
                        case prefix+'antiyt':
        if (!m.isGroup) throw reply(`This feature only be used in group`)
			if (!isAdmins) throw reply(`This feature could be used by admin only`)
			if (!isBotAdmins) throw reply(`Bot must be admin first`)
					if (args[1] === 'on') {
            if (isAntiYt) throw reply(`Udah aktif`)
            if (!isGroupAdmins && !isOwner) throw reply(mess.GrupAdmin)
            antiyt.push(from)
        ...
        if (!m.isGroup) throw reply(`This feature only be used in group`)
			...
			if (!isBotAdmins) throw reply(`Bot must be admin first`)
					if (args[1] === 'on') {
            if (isAntiTele) throw reply(`Udah aktif`)
            if (!isGroupAdmins && !isOwner) throw reply(mess.GrupAdmin)
            antitele.push(from)
        ...
        if (!m.isGroup) throw reply(`This feature only be used in group`)
			...
			if (!isBotAdmins) throw reply(`Bot must be admin first`)
					if (args[1] === 'on') {
            if (isAntiBitly) throw reply(`Udah aktif`)
            if (!isGroupAdmins && !isOwner) throw reply(mess.GrupAdmin)
            antibitly.push(from)
...
case prefix+'antilink':
			...
			if (!isBotAdmins) throw reply(`Bot must be admin first`)
					if (args[1] === 'on') {
						if (isAntiLink) throw reply('Already Activated')
						...
						if (!isAntiLink) throw reply('already deactivated')
 ...
 reply(`Pilih Antilink On / Off `)
             ...
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                ...
                if (!isAdmins) throw reply(mess.admin)
                if (args[1] === "on") {
                if (db.chats[m.chat].wame) throw reply(`Already Activated`)
                db.chats[m.chat].wame = true
                reply(`Anti Wa.me Activated!`)
                } else if (args[1] === "off") {
                if (!db.chats[m.chat].wame) throw reply(`Already deactivated`)
        ...
        case prefix+'nickff':{
        const axios = require('axios')
if (!q) throw reply(`Gunakan dengan cara ${command} *id*\n\n_Contoh_\n\n${command} 646675175`)
...
Nick : ${data.result}`
 ...
 var args1 = q.split("/")[0]
            var args2 = q.split("/")[1]                
            if (!q.includes("/")) throw reply(`Gunakan dengan cara ${command} *id/server*\n\n_Contoh_\n\n${command} 617243212/8460`)
...
Nick : ${data.result}`
            ...
            break
             ...
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                ...
                if (!isAdmins) throw reply(mess.admin)
                if (args[1] === "on") {
                if (db.chath[m.chat].mute) throw reply(`Already activated`)
                db.chats[m.chat].mute = true
                reply(`${Manik.user.name} has been muted in this group !`)
                } else if (args[1] === "off") {
                if (!db.chats[m.chat].mute) throw reply(`Already deactivated`)
...
`
            ...
            case prefix+'bc': case prefix+'broadcast': case prefix+'bcall':{
                ...
                if (!text) throw `Text mana?\n\nExample : ${prefix + command} dims-san`
		...
		reply('Broadcast Success')
            ...
            case prefix+'q': case prefix+'quoted':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
		if (!m.quoted) throw reply('Reply Message!!')
		let wokwol = await Manik.serializeM(await m.getQuotedObj())
		if (!wokwol.quoted) throw reply('The message you replied to does not contain a reply')
	    ...
	    break
            ...
            if (!quoted) reply `Balas Video/Image Dengan Caption ${prefix + command}`
                ...
                if ((quoted.msg || quoted).seconds > 11) throw reply('Maksimal 10 detik!')
                let media = await quoted.download()
...
message = await prepareWAMessageMedia({ image : { url: anu.thumbnail } }, { upload:   Manik.waUploadToServer })
	    ...
	    if (!isPremium && global.db.users[m.sender].limit < 1) throw reply(mess.endLimit) // respon ketika limit habis
            db.users[m.sender].limit -= 1 // -1 limit
                ...
                if (media.filesize >= 999999) throw reply('Audio size is too big '+util.format(media))
            ...
            db.users[m.sender].limit -= 1 // -1 limit
                ...
                if (media.filesize >= 999999) throw reply('Video size is too big '+util.format(media))
		...
		let { aiovideodl } = require('./FuncBot/scraper')
                ...
                if (media[0].formattedSize.split('MB')[0] >= 100000) throw reply('File Melebihi Batas'+util.format(media))
...
case prefix+'ig': case prefix+'igdl': case prefix+'Group': case prefix+'Groupdl':
if (!q) reply(`Kirim perintah ${command.slice(1)} link`)
 reply(mess.wait)
xfar.Group(q).then(async data => {
let txt = `*Group Downloader*\n\n`
txt += `*Title :* ${data.title}\n`
...
break
	    ...
	    case prefix+'anonymous':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (m.isGroup) throw reply('This Features Cannot Be Use in Group!')
...
———————————————————
Note: Owner Tidak Bertanggung Jawab Jika Ada Masalah Antara Pengguna Bot`, image: { url: "./media/anonymous.jpg" }, templateButtons: buttonsAnon, footer: 'Ochobot By Ochobot', mentions: [m.sender] })
			break
			}
case prefix+'sendprofile': case prefix+'sendcontact':{
            ...
            case prefix+'next': case prefix+'skip':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                if (m.isGroup) throw reply('This Feature Cannot Be Used In Group!')
                this.anonymous = this.anonymous ? this.anonymous : {}
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:Manik\n'
    + 'ORG:XdimsDev;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6281299609670:+62 857-3713-4572\n' 
    + 'item1.X-ABLabel:Creator Manik Bott\n'
    + 'item2.EMAIL;type=INTERNET:xdimsbot@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://chat.whatsapp.com/D8lpCpDxOPk7FeyElmTzgj\n'
    + 'item3.X-ABLabel:Group\n'
    + 'item4.ADR:;;Indonesia;;;;\n'
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
Manik.sendMessage(m.chat, { contacts: { displayName: 'XdimsDev', contacts: [{ vcard }] } }, { quoted: m })
            }
            break            
            case prefix+'author':{
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
...
reply('Hai Kak Ini Adalah Nomor Author Saya')
            ...
            break            
             ...
             addCountCmd(`#${command.slice(1)}`, sender, _cmd)
                    	...
                    	Manik.sendMessage(`6281299609670@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `Ochobot - Md Beta`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'Group',
                                    url: 'https://chat.whatsapp.com/D8lpCpDxOPk7FeyElmTzgj'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'Group',
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
              if (!text) reply `Example : ${prefix + command} black rover`
              reply('Tunggu Ya Kakak😊, Ochobot Carikan')
...
addCountCmd(`#${command.slice(1)}`, sender, _cmd)
       ...
       addCountCmd(`#${command.slice(1)}`, sender, _cmd)
              reply('Tunggu Ya Kak😊, Ochobot Carikan')
...
if (!isPremium && global.db.users[m.sender].limit < 1) throw reply(mess.endLimit) // respon ketika limit habis
            db.users[m.sender].limit -= 1 // -1 limit
    buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command.slice(1)}?apikey=${lolkey}`)
    Manik.sendImage(m.chat, buff, `Ochobot - By ©XdimsDev`, m)
 break
...
if (!isPremium && global.db.users[m.sender].limit < 1) throw reply(mess.endLimit) // respon ketika limit habis
            db.users[m.sender].limit -= 1 // -1 limit
    if (args.length == 0) throw reply(`Example: ${prefix + command} Transformer`)
    query = args.join(" ")
...
if (!isPremium && global.db.users[m.sender].limit < 1) throw reply(mess.endLimit) // respon ketika limit habis
            db.users[m.sender].limit -= 1 // -1 limit
    if (args.length == 0) throw reply(`Example: ${prefix + command} https://www.wattpad.com/707367860-kumpuLan-quote-tere-liye-tere-liye-quote-quote`)
    ini_url = args[1]
...
if (!isPremium && global.db.users[m.sender].limit < 1) throw reply(mess.endLimit) // respon ketika limit habis
            db.users[m.sender].limit -= 1 // -1 limit
    if (args.length == 0) throw reply(`Example: ${prefix + command} Tere Liye`)
    query = args.join(" ")
...
if (!isManik) throw reply(mess.owner)
if (args.length < 1) throw reply ("*Mau nyari file apa kak*")
sendfile = `${q}`
...
case prefix+'getcase':
if (!isManik) throw reply(mess.owner)
if (args.length < 1) throw reply ("*Mau nyari case apa kak*") 
const getCase = (cases) => {
...
if (!m.isGroup) throw reply(mess.group)
         if (!isManik) throw reply(mess.owner)
  if (args.length < 1) throw reply('_*Masukin id grupnya tolol*_')
  let pantek = []
 ...
 // Manik.groupAdd(q, pantek)
  break
case prefix+'stalkig':
                    if (args.length == 0) throw reply(`Example: ${prefix + command} jessnolimit`)
                    username = args[1]
                ...
                case prefix+'stalkgithub':
                    if (args.length == 0) throw reply(`Example: ${prefix + command} LoL-Human`)
                    username = args[1]
                ...
                case prefix+'stalktwitter':
                    if (args.length == 0) throw reply(`Example: ${prefix + command} jokowi`)
                    username = args[1]
                ...
                case prefix+'shortlink':
                    if (args.length == 0) throw reply(`Example: ${prefix + command} https://api.lolhuman.xyz`)
                    ini_link = args[1]
                    ini_buffer = await fetchJson(`https://api.lolhuman.xyz/api/shortlink?apikey=${lolkey}&url=${ini_link}`)
                    reply(ini_buffer.result)
                    break
                case prefix+'spamsms':
                if (!isPremium && !m.key.fromMe && !isManik) throw reply(mess.prem)
                    if (args.length == 0) throw reply(`Example: ${prefix + command} 08303030303030`)
                    nomor = args[1]
                    ...
                    break
                    case prefix+'limit+': 
if (!global.db.users[m.sender].limit < 1) throw reply(`S u k s e s Menambah Limit`) // respon ketika limit habis
...
const reactionMessage = {
 ...
 break
        ...
        case prefix+'item':
        if (!m.isGroup) throw reply(mess.group)
                    if (!m.isGroup) throw reply(mess.OnlyGrup)
            if (db_respon_list.length === 0) throw reply(`Belum ada list message di database`)
            if (!isAlreadyResponListGroup(from, db_respon_list)) throw reply(`Belum ada list message yang terdaftar di group ini`)
            var arr_rows = [];
...
const sendMsg = await Manik.sendMessage(m.chat, listMessage)
        ...
        if (!m.isGroup) throw reply(mess.group)
            if (!m.isGroup) throw reply(mess.OnlyGrup)
            if (!isAdmins && !isManik) throw reply('Only Admins')
            var args1 = text.split("@")[0]
            var args2 = text.split("@")[1]                
            if (!q.includes("@")) throw reply(`Gunakan dengan cara ${command.slice(1)} *Nama Item@Item*\n\n_Contoh_\n\n${command.slice(1)} Dm Ml@List`)
            if (isAlreadyResponList(from, args1, db_respon_list)) throw reply(`List respon dengan key : *${args1}* sudah ada di group ini.`)
            if (/image/.test(mime)) {
        ...
        if (!m.isGroup) throw reply(mess.group)
            ...
            if (!isAdmins && !isManik) throw reply('Only Admins')
            if (db_respon_list.length === 0) throw reply(`Belum ada list message di database`)
            if (!q) throw reply(`Gunakan dengan cara ${command.slice(1)} *Nama Item*\n\n_Contoh_\n\n${command.slice(1)} Dm Ml`)
            if (!isAlreadyResponList(from, q, db_respon_list)) throw reply(`List Item dengan Nama *${q}* tidak ada di database!`)
        ...
        case prefix+'changeitem': case prefix+'change':
            ...
            var args2 = q.split("@")[1]
            if (!q.includes("@")) throw reply(`Gunakan dengan cara ${command.slice(1)} *Nama Item@Item*\n\n_Contoh_\n\n${command.slice(1)} Dm Ml@List`)
            if (!isAlreadyResponListGroup(from, db_respon_list)) throw reply(`Maaf, untuk key *${args1}* belum terdaftar di group ini`)
            if (/image/.test(mime)) {
                let media = await Manik.downloadAndSaveMediaMessage(m.message.imageMessage || m.message.extendedTextMessage?.contextInfo.quotedMessage.imageMessage, 'image')
              const fd = new FormData();
                fd.append('file', fs.readFileSync(media), '.tmp', '.jpg')
        ...
        case prefix+'tambah':
            if (args.length < 3) throw reply(`Gunakan dengan cara ${command.slice(1)} *angka* *angka*\n\n_Contoh_\n\n${command.slice(1)} 1 2`)
        ...
        case 'cekproses':
            ...
            if (!m.quoted) throw reply('Reply Bukti Pembayaran!!')
            if (!m.quoted.text) {
        ...
        case 'proses':
            ...
            if (!isManik && !groupAdmins) return
            if (!m.quoted) throw reply('Reply Bukti Pembayaran!!')
            if (!text) throw reply('Masukan Catatan Pelanggan\nContoh: proses 11 Diamond Ml | Id 12345678(1234)')
            let numb = m.sender
            let proses = `「 *TRANSAKSI PENDING* 」\n\n\`\`\`📆 TANGGAL : ${tanggal}\n⌚ JAM     : ${jam}\n✨ STATUS  : Pending\`\`\`\n\n📝 Catatan :\n${text}\n\nPesanan @${numb.split("@")[0]} sedang di proses!`
            mentions(proses, numb, true)
            m.quoted.copyNForward(`6281299609670@s.whatsapp.net`, true)
            Manik.sendMessage(`6281299609670@s.whatsapp.net`, {text: proses })
            break
        case 'done':
            if (!isManik) return
            if (args.length == 1) throw reply('Masukan Nomor Pelanggan\nContoh: done 62xxx|catatan')
            if (args.length == 2) throw reply('Masukan Catatan Transaksi')
            if (args[1].includes('+')) throw reply(`Jangan menggunakan +`)
            if (isNaN(parseInt(args[1]))) throw reply('Harus Berupa Angka!')
            ...
            break
            case prefix+'react':
                      if (!isManik) throw reply('Manik Aja')
                      if (!isQuotedMsg) throw reply(`Balas pesannya`)
                      if (args.length < 2) throw reply(`Masukkan 1 emoji`)
                      if (!isEmoji(args[1])) throw reply(`Itu bukan emoji!`)
                      if (isEmoji(args[1]).length > 1) throw reply(`Satu aja emojinya`)
          ...
          if (args.length === 0) throw reply(`Buat list dengan judul\n\nContoh : ${prefix}addjudultugas | <judul tugas>`);
          if (judullist.length > 0) throw reply(`Mohon untuk reset tugas terlebih dahulu dengan command ${prefix}resettugas`);
          const isijudullist = q.split(`|`)[1];
          const judulin = judullist.push(isijudullist);
          if (judulin) throw reply(`Tugas sudah ditambahkan, untuk menambahkan tugas menggunakan command ${prefix}addtugas | <nama tugas>`);
          break;
        
        case prefix+'addtugas':
          if (args.length === 0) throw reply(`Tambah daftar Tugas dengan isi\n\nContoh : ${prefix}addtugas | <nama tugas>`);
          if (judullist.length === 0) throw reply(`Mohon untuk membuat judul Tugas terlebih dahulu dengan command ${prefix}addjudultugas`);
        ...
        case prefix+'hapustugas':
          if (args.length === 0) throw reply(`Hapus item pada List dengan nomor item\n\nContoh : ${prefix}hapustugas 1`);
          if (daftarlist.length === 0) throw reply(`Tambah daftar tugas dengan isi\n\nContoh : ${prefix}addtugas | <nama tugas>`);
          if (judullist.length === 0) throw reply(`Mohon untuk membuat judul tugas terlebih dahulu dengan command ${prefix}addjudultugas`);
          var i = args[1];
          i--;
        ...
        case prefix+'resettugas':
          ...
          if (daftarlist.length === 0 && judullist.length === 0) throw reply(`tugas sudah di reset !`);
          break;
